...
<div id="content" class="content"  >
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">Call Log List</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">
        ...
        if ($contact) {
            if ($device_id) {
                ...
                $contobj = $contact[0];
                echo "Total Call Log:" . $contobj['totalcontact'];
            }
        }
        ?>
    </h1>
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                ?>
                <a href="<?php echo site_url("Account/getCallLogCsv/$device_id"); ?>" class="btn btn-success">Export CSV</a>
                ...
                <h2 style="text-transform: capitalize">Call Log List
...
<script>
    ...
    $(function () {
        ...
        $('#tableData').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo site_url("Api/getCallLogApi/" . $device_id) ?>",
                type: 'GET'
            },
            "columns": [
                {"data": "s_n"},
